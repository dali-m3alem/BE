...
public class ProjectController {
    ...
    @GetMapping("/activityOfProject/{id}")
    public ResponseEntity<Project> ActivitiesOfProject(@PathVariable Long id) {
        Project project = projectService.ActivitiesOfProject(id);
        if (project != null) {
